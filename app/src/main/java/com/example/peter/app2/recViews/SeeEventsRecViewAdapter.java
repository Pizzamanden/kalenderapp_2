package com.example.peter.app2.recViews;
...
public class SeeEventsRecViewAdapter extends RecyclerView.Adapter<SeeEventsRecViewAdapter.ViewHolder>{

    private static final String TAG = "RecyclerViewAdapter";

    // Define ArrayList names to be used in Construct, and then in onBindViewHolder
    // private ArrayList<String> mArrayList = new ArrayList<>();
    private String heyString;

    public SeeEventsRecViewAdapter(String aString) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.layout_recview_seeevents, viewGroup, false);
    ...
    public int getItemCount(){
        ...
        // Amount of times to make layout
